        ...
        <div className="z-10 w-full max-w-3xl">
          <TerminalCard title="crypton@root:~" glowing={true} className="shadow-2xl">
            <div className="text-lg md:text-xl space-y-4">
              ...
              <div className="pt-4 text-3xl md:text-5xl font-bold text-white tracking-wide">
                <span className="text-cyber-neon">{'>'}</span> {text}
                <span className="animate-cursor-blink inline-block w-3 h-8 md:h-12 bg-cyber-neon ml-2 align-middle"></span>
              </div>
              <p className="pt-6 text-gray-300 max-w-xl">
              ...
              <div className="pt-8 flex flex-wrap gap-4">
                <Link to="/events" className="bg-cyber-neon text-black font-bold px-6 py-3 rounded hover:bg-white hover:shadow-[0_0_20px_#39FF14] transition-all flex items-center gap-2">
                  <Terminal size={18} />
                  Start Hacking
                </Link>
                <Link to="/members" className="border border-cyber-neon text-cyber-neon px-6 py-3 rounded hover:bg-cyber-neon/10 transition-all">
                  Meet the Agents
                </Link>
              </div>
            </div>
